...
/**
 * Author: Queen
 * Date: 2020/7/17 1:21 PM
 * Describe: Test16Activity2Fragment
 */
class Test16Activity2Fragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_test16_2_dummy, container, false).apply {
    ...
    companion object {
        fun newInstance(param1: Int, param2: Int, param3: String) = Test16Activity2Fragment().apply {
