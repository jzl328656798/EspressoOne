 ...
 * Describe: TODO
 */
public class Activity12ViewGroupA extends ViewGroup {

    protected final String TAG = getClass().getSimpleName();

    public Activity12ViewGroupA(Context context) {
        super(context);
    }

    public Activity12ViewGroupA(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public Activity12ViewGroupA(Context context, AttributeSet attrs, int defStyleAttr) {
